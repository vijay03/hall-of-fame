all: authors.data sosp.data osdi.data
	...
	cat top.html | ssh  vijay@dung-beetle.cs.utexas.edu 'cat - > ~/public_html/hall.html; chmod 777 ~/public_html/hall.html'
	open top.html
...
active: authors.data
	...
	cat top-active.html | ssh  vijay@dung-beetle.cs.utexas.edu 'cat - > ~/public_html/hall-active.html; chmod 777 ~/public_html/hall-active.html'
